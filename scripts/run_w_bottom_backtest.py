...
from src.backtest.w_bottom_backtest import get_or_run_w_bottom_backtest
...
def print_summary(summary) -> None:
    ...
    print()
    print("明細：data/w_bottom_backtest_trades.csv")
    print("摘要：data/w_bottom_backtest_summary.json")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="N漲W底假跌破歷史回測")
...
def main() -> int:
    ...
    summary = get_or_run_w_bottom_backtest(
